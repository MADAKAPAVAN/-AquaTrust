"""
AquaTrust v3 — Step 64: Automated Scientific Poster Generator
=============================================================
Generates a standalone, print-ready HTML5/CSS3 scientific poster
formatted for A2/A1 landscape presentation (594mm x 420mm).

Features:
  - 3-Column Asymmetric Academic Grid
  - Embedded 300 DPI Figure Assets (Figures 1, 2, 3, 4, 5, 6)
  - Pre-styled Canonical Results & CRC Benchmark Tables
  - Clean CSS Print Stylesheet for direct PDF export via Chrome/Edge (Ctrl+P)

Outputs:
  - D:/AquaTrust/poster/index.html
"""
...
<div class="grid-container">
    ...
    <div class="panel" style="flex: 1.3;">
      ...
      <div class="panel-content">
        ...
        <div style="background:#0d1b2a; padding:4px 8px; border-radius:4px; font-size:8.5pt; text-align:center; margin:4px 0; border:1px solid #415a77;">
          $P(y_i=1 \mid X_i) = \sigma\left(\mathbf{w}^T \widetilde{\mathbf{X}}_i + (\mathbf{w}_{\text{inter}}^T \widetilde{\mathbf{X}}_i) \cdot \hat{k}_i\right)$
        </div>
      </div>
    </div>
      ...
      <div class="panel-content">
        <div class="dual-fig-grid">
          <div class="fig-container">
            <img src="../figures/Figure_1_Master_Reliability_Diagram.png" alt="Figure 1">
            <div class="fig-caption">Fig 1: Master Reliability Curves across 10 Bins (N=2,115).</div>
          </div>
          <div class="fig-container">
            <img src="../figures/Figure_2_Ablation_Forest_Plot.png" alt="Figure 2">
            <div class="fig-caption">Fig 2: 95% Bootstrap CIs for Δ ECE & Δ Risk@80% (B=2,000).</div>
          </div>
        </div>
        <div class="fig-container" style="margin-top: 6px;">
          <img src="../figures/Figure_3_Selective_Risk_Coverage.png" alt="Figure 3" style="max-height: 140px;">
  ...
  <div class="col">
    ...
    <div class="panel" style="flex: 1.5;">
      ...
      <div class="panel-content">
        <p><strong>Image-Level Any-Error CRC Theorem:</strong> Calibrating over physical sonar images ($M=117$) guarantees marginal expected risk bounds: $\mathbb{E}_{V,T}[L_{\text{test}}^{\text{AnyError}}(\hat{\tau})] \le \alpha$.</p>
        <div class="fig-container">
          <img src="../figures/Figure_4_Conformal_Utility_Frontier.png" alt="Figure 4" style="max-height: 130px;">
    ...
    <div class="panel" style="flex: 1.5;">
      ...
      <div class="panel-content">
        <div class="dual-fig-grid">
          <div class="fig-container">
            <img src="../figures/Figure_5_Marginal_vs_PAC_CRC_Tradeoff.png" alt="Figure 5">
            <div class="fig-caption">Fig 5: Marginal vs. PAC 90%/95% Confidence.</div>
          </div>
          <div class="fig-container">
            <img src="../figures/Figure_6_Operational_Disagreement_Case.png" alt="Figure 6">
...
poster_html_path = POSTER_DIR / "index.html"
poster_html_path.write_text(html_content, encoding="utf-8")

print("=" * 95)
print("  ✅ STEP 64 COMPLETE — Standalone Scientific Poster Generated")
print(f"  • HTML Poster Path : {poster_html_path}")
print("=" * 95)
